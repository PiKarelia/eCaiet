var ComponentsDropdowns = function () {
    ...
    var handleMultiSelect = function () {
        $('#my_multi_select1').multiSelect({
			selectableHeader: "<div class='custom-header'>All Groups</div>",
			selectionHeader: "<div class='custom-header'>Selected Groups</div>",
		});
        $('#my_multi_select3').multiSelect({
			selectableHeader: "<div class='custom-header'>All Securities</div>",
			selectionHeader: "<div class='custom-header'>Selected Securities</div>",
		});
